...
# ------------------------------------------------------------------
def makergb_nightfog(ch4r,ch9,ch10,outprfx):
...
# ------------------------------------------------------------------
def makergb_fog(ch7,ch9,ch10,outprfx):
    import sm_display_util
    import Numeric
...
# ------------------------------------------------------------------
def makergb_severe_convection(ch1,ch3,ch4,ch5,ch6,ch9,outprfx):
    import sm_display_util
    import Numeric
...
# ------------------------------------------------------------------
def makergb_redsnow(ch1,ch3,ch9,outprfx):
    import sm_display_util
    import Numeric
...
# ------------------------------------------------------------------
def makergb_cloudtop(ch4,ch9,ch10,outprfx):
    import sm_display_util
    import Numeric
