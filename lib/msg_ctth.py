...
def msg_ctth2ppsformat_numeric(msgctth,satid="Meteosat 8"):
    import area,string, Numeric
    ...
    retv.processingflag=convert_procflags2pps_numeric(msgctth.processing_flags.data)
